        ...
        <div className="text-center mb-6">
          {hasLogo ? (
            <img
              ...
              alt=""
              className="inline-flex h-14 w-14 object-contain bg-white/10 rounded-2xl mb-3 p-1.5"
            />
          ) : (
            <div className="inline-flex items-center justify-center h-14 w-14 bg-white/10 rounded-2xl mb-3">
